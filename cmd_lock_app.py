...
from crypto import load_password, save_password, get_key_path
...
def initial_setup():
    ...
    appdata_key_file = get_key_path()
    current_folder = os.path.abspath(os.path.dirname(__file__))
    password_filename = "pas1.json"  # Updated according to crypto.py
    password_file_path = os.path.join(appdata_folder, password_filename)  # Updated path
